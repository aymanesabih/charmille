...
import { FaTwitter, FaGithub, FaLinkedin ,FaMountain} from 'react-icons/fa';

export default function Footer() {
  return (
    <footer className="grid grid-cols-5 gap-4 w-full py-6 text-sm border-t-2 border-gray-100 dark:border-gray-800">
        <div className="flex items-center space-x-2">
          <img src="/Fouterlogo.png" alt="Mountain Icon" className="h-15 w-15" />
